...
public class KingTests {
    ...
    public void King_canMoveTwoSpaces_returnsFalse() {
        board[5][5] = new King(board, 5, 5, true);
        assertAll(
                () -> assertFalse(board[5][5].canMoveTo(3, 3),
                        "Kings must not be able to move more than 1 square in all directions"),
                () -> assertFalse(board[5][5].canMoveTo(3, 5),
                        "Kings must not be able to move more than 1 square in all directions"),
                () -> assertFalse(board[5][5].canMoveTo(3, 7),
                        "Kings must not be able to move more than 1 square in all directions"),
                () -> assertFalse(board[5][5].canMoveTo(5, 3),
                        "Kings must not be able to move more than 1 square in all directions"),
                () -> assertFalse(board[5][5].canMoveTo(5, 7),
                        "Kings must not be able to move more than 1 square in all directions"),
                () -> assertFalse(board[5][5].canMoveTo(7, 3),
                        "Kings must not be able to move more than 1 square in all directions"),
                () -> assertFalse(board[5][5].canMoveTo(7, 5),
                        "Kings must not be able to move more than 1 square in all directions"),
                () -> assertFalse(board[5][5].canMoveTo(7, 7),
                        "Kings must not be able to move more than 1 square in all directions"));
    }
    ...
    public void King_doMove_changesBoard() {
        ...
        board[2][0] = new ChessPiece(board, 2, 0, false);

        board[7][0].moveTo(6, 0);

        board[0][0].moveTo(1, 0);
        board[1][0].moveTo(2, 0);
